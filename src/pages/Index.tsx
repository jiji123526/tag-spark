...
const Index = () => {
  ...
  const recommendations = useMemo(() => {
    ...
    const tagsByWork = mappings.reduce<Record<number, Record<number, number>>>(
      (acc, m) => {
      ...
      <main className="container pt-20 pb-16">
        <section aria-labelledby="hero">
          <h1 id="hero" className="text-2xl font-semibold tracking-tight">
            Interactive Tag-Based Recommendations
          </h1>
          <p className="mt-2 text-muted-foreground">
            Select multiple tags to instantly filter and rank creative works.
          </p>
        </section>
